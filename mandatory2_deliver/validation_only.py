...
from cocoSource_xcnnfused_task4 import RNNOneLayerSimplified
...
if __name__ == '__main__':
    ...
    modelParam = {
        ...
        'numbOfEpochs': 80,  # Number of epochs
        'data_dir': data_dir,  # data directory
        'img_dir': 'loss_images_test/',
        'modelsDir': 'storedModels_test/',
        'modelName': 'model__validation_task4/',  # name of your trained model
        'restoreModelLast': 0,
        'restoreModelBest': 0,
    ...
    config = {
        ...
        'cellType':  'LSTM' #'GRU'  # RNN or GRU or GRU??
    }
